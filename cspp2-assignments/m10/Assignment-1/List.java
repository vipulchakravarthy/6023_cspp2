...
public class List {
    ...
    */
    ...
    /**
     * Counts how many times the element is present.
     * @param      item  The item or element to find
     * @return     Number of element.
     */
    public int countElement(final int item) {
        int countOf = 0;
   ...
   *Inserts all the elements of specified int
    ...
    */
    public void addAll(int[] temp) {
        int j = 0;
        for (int i = size; i < (size + temp.length)-1; i++) {
            list[i] = temp[j];
            j++;
        }
