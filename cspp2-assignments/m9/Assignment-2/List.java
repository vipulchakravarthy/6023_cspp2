	...
	public static void main(String[] args) {
        ...
        while (stdin.hasNext()) {
            ...
            switch (tokens[0]) {
                ...
                break;
                case "remove":
                listObj.remove(Integer.parseInt(tokens[1]));
                break;
                case "indexOf":
                System.out.println(listObj.indexOf(Integer.parseInt(tokens[1])));
                break;
                case "get":
                System.out.println(listObj.get(Integer.parseInt(tokens[1])));
                break;
                case "contains":
                System.out.println(listObj.contains(Integer.parseInt(tokens[1])));
                break;
                default:
            }
        }
